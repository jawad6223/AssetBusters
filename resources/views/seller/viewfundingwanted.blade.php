  ...
  <div class="parallax titlebar" data-background="{{asset('public/assets1/images/listing-02.jpg')}}" data-color="rgba(48, 48, 48, 1)" data-color-opacity="0.8" data-img-width="800" data-img-height="505">
    <div id="titlebar">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2>Funding wanted</h2>
            <!-- Breadcrumbs -->
            <nav id="breadcrumbs">
              <ul>
                <li><a href="index.html">Home</a></li>
                <li>funding wanted</li>
              </ul>
            </nav>
          </div>
        </div>
      ...
      <div class="col-md-9">
        <table class="manage-table responsive-table">
          ...
          <tr>
            ...
            <td class="utf-expire-date">{{ date('d-m-Y', strtotime($funding->created_at));}}</td>
            <td class="action">
				<a href="{{url('seller/readfundingwanted/' . $funding->id)}}" class="view tooltip left" title="View"><i class="icon-feather-eye"></i></a>
				<a href="{{url('seller/editfundingwanted/' . $funding->id)}}" class="edit tooltip left" title="Edit"><i class="icon-feather-edit"></i></a> 
				<a href="{{url('seller/deletefundingwanted/' . $funding->id)}}" class="delete tooltip left" title="Delete"><i class="icon-feather-trash-2"></i></a>
			</td>
          </tr>
          @endforeach
        </table>
        <a href="{{url('seller/addfundingwanted')}}" class="utf-centered-button margin-top-30 button">Add New Funding wanted</a> 
	  </div>
    </div>
  </div>
