        ...
        <div class="submit-page">
		  ...
		  <div class="utf-submit-page-inner-box">
              ...
              <div class="margin-top-65"></div>
                  ...
                  <div id="dropzone">
        <form action="{{ route('dropzoneFileUpload8') }}" class="dropzone"  id="file-upload" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="funding_wanted_id" id="post_id" value="{{$id1}}">
