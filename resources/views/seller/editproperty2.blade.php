         ...
         <div class="container">
               ...
               <div class="col-md-9">
                  <table class="manage-table responsive-table" id="datatable_page">
                     ...
                     <tr>
                        ...
                        <td class="action">
                           <a href="{{url('seller/imagepropertydelete/'.$image->id)}}" onClick="return confirm('Are you sure?')" class="delete tooltip left" title="Delete"><i class="icon-feather-trash-2"></i></a>
                        </td>
                     </tr>
                     @endforeach
                     ...
                     <tr>
                        ...
                        <td class="action">
                           <a href="{{url('seller/videopropertydelete/'.$video->id)}}" class="delete tooltip left" title="Delete"><i class="icon-feather-trash-2"></i></a>
                        </td>
                     </tr>
                     @endforeach
                  </table>
		  ...
		  <div class="utf-submit-page-inner-box">
              ...
              <div class="margin-top-65"></div>
                  ...
                  <div id="dropzone">
        <form action="{{ route('dropzoneFileUpload3') }}" class="dropzone"  id="file-upload" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="property_id" id="post_id" value="{{$id}}">
