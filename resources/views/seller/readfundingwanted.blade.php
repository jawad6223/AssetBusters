         ...
         <div class="parallax titlebar" data-background="{{asset('public/assets1/images/listing-02.jpg')}}" data-color="rgba(48, 48, 48, 1)" data-color-opacity="0.8" data-img-width="800" data-img-height="505">
            <div id="titlebar">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <h2>Funding Wanted Detail</h2>
                        <!-- Breadcrumbs -->
                        <nav id="breadcrumbs">
                           <ul>
                              <li><a href="index.html">Home</a></li>
                              <li>Funding Wanted Detail</li>
                           </ul>
                        </nav>
                     </div>
                  </div>
         ...
         <div class="container">
            <div class="row">
               ...
               <div id="titlebar-dtl-item" class="property-titlebar margin-bottom-0">
                     ...
                     @if($funding->funding_wanted_id == 1) Agriculture / Cannabis @endif
                                  @if($funding->funding_wanted_id == 2)  Crypto / Blockchain @endif
                              @if($funding->funding_wanted_id == 3)  Entertainment / Film / TV @endif
                                @if($funding->funding_wanted_id == 4) Green Energy / Solar / Renewables @endif
                            @if($funding->funding_wanted_id == 5)  Hotels / Restaurants / Bars @endif

                                 
                                 @if($funding->funding_wanted_id == 6) Internet / Online / Tech @endif
                                @if($funding->funding_wanted_id == 7) Medical / Pharma / Biotech @endif
                                  @if($funding->funding_wanted_id == 8)  Mining / Metals @endif
                                @if($funding->funding_wanted_id == 9)  Oil & Gas @endif
                           @if($funding->funding_wanted_id == 10) Real Estate @endif
