      ...
      <div id="wrapper">
         ...
         <div class="container">
            <div class="row">
               ...
               <!-- Submit Page -->
               <form action="{{url('seller/addfundingaction')}}" method="post"  enctype="multipart/form-data">
               @csrf
               <div class="col-md-9">
                        ...
                        <div class="content with-padding">
                           ...
                           <div class="col-md-6">
                              ...
                              <select class="utf-chosen-select-single-item" required name="funding_type_id" >
                                 ...
                                 <option value="1"> Factoring / Receivables / Contracts Funding</option>
                                 <option value="2"> Loan / Mortgage</option>
                                 <option value="3"> Private Equity / Venture Capital</option>
                                 <option value="4"> Private Offering / Reg A+ / Reg CF</option>
                                 <option value="5"> Public Offering / IPO / SPAC</option>
