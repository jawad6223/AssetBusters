      ...
      <div class="col-md-9">
        <table class="manage-table responsive-table">
          ...
          <tr>
            ...
            <td class="action">
				<a href="{{url('seller/readfunding/' . $funding->id)}}" class="view tooltip left" title="View"><i class="icon-feather-eye"></i></a>
				<a href="{{url('seller/editfunding/' . $funding->id)}}" class="edit tooltip left" title="Edit"><i class="icon-feather-edit"></i></a> 
				<a href="{{url('seller/deletefunding/' . $funding->id)}}" class="delete tooltip left" title="Delete"><i class="icon-feather-trash-2"></i></a>
			</td>
          </tr>
          @endforeach
        </table>
        <a href="{{url('seller/addfunding')}}" class="utf-centered-button margin-top-30 button">Add New Funding Source</a> 
	  </div>
    </div>
  </div>
