      ...
      <div id="wrapper">
         ...
         <div class="container">
            <div class="row">
               ...
               <form action="{{url('seller/sellermyprofileaction')}}" method="post"  enctype="multipart/form-data">
                  @csrf
                  <div class="col-md-9">
                        ...
                        <div class="utf-submit-page-inner-box">
                           ...
                           <div class="content with-padding">
                              <div class="col-md-6">
                                 ...
                                 <input value="{{$seller->name}}" name="name" required type="text">
                              </div>
                              <div class="col-md-6">	
                                 <label>Email Address</label>
                                 <input value="{{$seller->email}}" name="email" required type="email">
                              </div>
                              <div class="col-md-6">	
                                 <label>Image</label>
                              ...
                              <div class="col-md-6">
                                 <label>Contact</label>
                                 <input value="{{$seller->contact}}" name="contact"  type="text">
                              </div>
                              <div class="col-md-6">
                                 <label>Type</label>
                                 <select class="utf-chosen-select-single-item"  name="usertype" id="Select">
                                 <option value="1" @if($seller->user_type == 1)   {{'selected="selected"'}} @endif  >Owner</option>
                                 
                                 <option value="3"    @if($seller->user_type == 3)   {{'selected="selected"'}} @endif  >Funding Sources</option>
                                 <option  value="4"   @if($seller->user_type == 4)   {{'selected="selected"'}} @endif  >Broker</option>
                                 </select>
                              </div>
                              <div class="col-md-6">
                                 <label>Street</label>
                                 <input value="{{$seller->street}}" name="street"  type="text">
                              </div>
                              <div class="col-md-6">
                                 <label>City</label>
                                 <input value="{{$seller->city}}" name="city"type="text">
                              </div>
                              <div class="col-md-6">
                                 <label>State</label>
                                 <input value="{{$seller->state}}" name="state"  type="text">
                              </div>
                              <div class="col-md-6">
                                 <label>Zip</label>
                                 <input value="{{$seller->zip}}" name="zip"  type="text">
                              </div>
                              <div class="col-md-6">
                                 <label>Country</label>
                                 <input value="{{$seller->country}}" required name="country" type="text">
                              </div>
                              <div class="col-md-12 margin-bottom-0">
                                 <label>Description</label>
                                 <textarea name="description" id="about" cols="20" rows="5"> {{$seller->description}}</textarea>
                              </div>
                           </div>
                        </div>
                        <div class="utf-submit-page-inner-box">
                           ...
                           <div class="content with-padding">
                              <div class="col-md-6">
                                 ...
                                 <input value="{{$seller->facebook}}" name="facebook" type="url">
                              </div>
                              <div class="col-md-6">
                                 <label><i class="icon-brand-twitter"></i> Twitter</label>
                                 <input value="{{$seller->twitter}}" name="twitter" type="url">
                              </div>
                              <div class="col-md-6">
                                 <label><i class="icon-brand-linkedin"></i> Linkedin</label>
                                 <input value="{{$seller->linkedin}}" name="linkedin" type="url">
                              </div>
                              <div class="col-md-6">
                                 <label><i class="icon-feather-instagram"></i> Instagram</label>
                                 <input value="{{$seller->instagram}}" name="instagram" type="url">	
                              </div>
                           </div>
                        </div>
                        <div class="row">
