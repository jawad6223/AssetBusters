   ...
   <body>
      ...
      <div id="wrapper">
               ...
               <div class="col-md-9">
                  <table class="manage-table responsive-table" id="datatable_page">
                     ...
                     <tr>
                        ...
                        <td class="action">
                           <a href="{{url('seller/imagebusinessdelete/'.$image->id)}}" onClick="return confirm('Are you sure?')" class="delete tooltip left" title="Delete"><i class="icon-feather-trash-2"></i></a>
                        </td>
                     </tr>
                     @endforeach
                     ...
                     <tr>
                        ...
                        <td class="action">
                           <a href="{{url('seller/videobusinessdelete/'.$video->id)}}" class="delete tooltip left" title="Delete"><i class="icon-feather-trash-2"></i></a>
                        </td>
                     </tr>
                     @endforeach
                  </table>
        ...
        <form action="{{ route('dropzoneFileUpload1') }}" class="dropzone"  id="file-upload" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="business_id" id="post_id" value="{{$id}}">
