      ...
      <div id="wrapper">
         ...
         <div class="container">
            <div class="row">
               ...
               <!-- Submit Page -->
               <form action="{{url('seller/editfundingaction')}}" method="post"  enctype="multipart/form-data">
               @csrf
               <div class="col-md-9">
                        ...
                        <input   name="id"  type="hidden" value="{{$funding->id}}"/>	
                           ...
                           <div class="col-md-6">
                              ...
                              <select class="utf-chosen-select-single-item" required name="funding_type_id" >
                                 ...
                                 <option value="1" @if($funding->funding_type_id == 1){{'selected="selected"'}}  @endif> Factoring / Receivables / Contracts Funding</option>
                                 <option value="2" @if($funding->funding_type_id == 2) {{'selected="selected"'}}  @endif> Loan / Mortgage</option>
                                 <option value="3" @if($funding->funding_type_id == 3) {{'selected="selected"'}}  @endif> Private Equity / Venture Capital</option>
                                 <option value="4" @if($funding->funding_type_id == 4) {{'selected="selected"'}}   @endif> Private Offering / Reg A+ / Reg CF</option>
                                 <option value="5" @if($funding->funding_type_id == 5) {{'selected="selected"'}}  @endif> Public Offering / IPO / SPAC</option>
