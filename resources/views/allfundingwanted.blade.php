         ...
         <div class="container">
            ...
            @if($funding->count() == 0)
               ...
               <div class="col-md">
                  ...
                  <div class="col-md-4">
                     <div class="blog-post">
                        <a href="{{url('fundingdetailwanted/' . $funding->id)}}" class="post-img"> <img src="{{asset('storage/app/' . $funding->primaryimage)}}" style="height:230px;" alt=""> </a> 
                        <div class="utf-post-content-area">
                           <h3><a href="{{url('fundingdetailwanted/' . $funding->id)}}">{{$funding->title}}</a></h3>
                           <div class="utf-listing-user-info"><a href="{{url('homesellerprofile/ ' .$funding->funding_user->id)}}">
                             <i class="icon-line-awesome-user"></i> {{$funding->funding_user->name}}</a> <span>{{ $funding->created_at->format('d/m/Y') }}</span>
                            </div>
