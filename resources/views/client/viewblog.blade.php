      ...
      <div class="col-md-9">
        <table class="manage-table responsive-table">
          ...
          <tr>
            ...
            <td class="utf-expire-date ">{{ date('d-m-Y', strtotime($blog->created_at));}}</td>
            <td class="action">
				<a href="{{url('client/readblog/'.$blog->id)}}" class="view tooltip left" title="View"><i class="icon-feather-eye"></i></a>
				<a href="{{url('client/editblog/' .$blog->id)}}" class="edit tooltip left" title="Edit"><i class="icon-feather-edit"></i></a> 
				<a href="{{url('client/deleteblog/' .$blog->id)}}" class="delete tooltip left" title="Delete"><i class="icon-feather-trash-2"></i></a>
			</td>
          </tr>

          @endforeach
        </table>
        <a href="{{url('client/addblog')}}" class="utf-centered-button margin-top-30 button">Add New Blog</a> 
	  </div>
    </div>
  </div>
