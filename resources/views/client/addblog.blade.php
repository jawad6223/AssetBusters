      ...
      <div id="wrapper">
         ...
         <div class="container">
            <div class="row">
               ...
               <form action="{{url('client/addblogaction')}}" method="post"  enctype="multipart/form-data">
               @csrf
               <!-- Submit Page -->
               <div class="col-md-9">
                  <div class="submit-page">
                     ...
                     <div class="utf-submit-page-inner-box">
                        ...
                        <div class="content with-padding">
                           <div class="col-md-12">
                              <h5>Blog Title</h5>
                              <input class="search-field" placeholder="Blog Title" required name="title" type="text" value=""/>				  
                           </div>
                           <div class="col-md-12">
                              <h5>Primary Image</h5>
                              <input class="search-field" name="image" type="file" required value=""/>				  
                           </div>
                           <div class="col-md-12">
                              <h5> Description</h5>
