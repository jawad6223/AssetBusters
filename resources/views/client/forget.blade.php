        ...
        <div class="my-account">
          <div class="tabs-container"> 
            <!-- Login -->
              ...
              <form method="post" action="{{url('client/clientforgetaction')}}"  class="login">
                 @csrf
                <div class="form-row form-row-wide">
                    <input type="email" class="input-text" name="email" required id="email" placeholder="Email Address" value="" />
                </div>
