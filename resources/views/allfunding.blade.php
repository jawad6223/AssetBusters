         ...
         <div class="container">
            ...
            @if($funding->count() == 0)
               ...
               <div class="col-md">
                  ...
                  <div class="col-md-4">
                     <div class="blog-post">
                        <a href="{{url('fundingdetail/' . $funding->id)}}" class="post-img"> <img src="{{asset('storage/app/' . $funding->primaryimage)}}" style="height:230px;" alt=""> </a> 
                        <div class="utf-post-content-area">
                           <h3><a href="{{url('fundingdetail/' . $funding->id)}}">{{$funding->title}}</a></h3>
