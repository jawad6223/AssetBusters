        ...
        <div class="row">
          <div class="col-12">     
            <div class="login-card">
              <div>
                <div><a class="logo" href=""><img class="img-fluid for-light" src="{{asset('public/assets/images/logo/login.png')}}"  style="width:150px;height:80px;" alt="looginpage"></a></div>
              ...
              Something wrong Try again
               ...
               @endif
                <form class="theme-form "  method="post" action="{{url('admin/adminforgetaction')}}">
